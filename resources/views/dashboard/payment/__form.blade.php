<div class="form">
    <div class="form-group">
        ...
        @enderror" id="student_id"
            name="student_id" >
                <option value="{{ $students->id }}" @if ($students->id == old('student_id', $payments->student_id)) selected @endif>
    ...
    <div class="form-group">
        <x-dashboard.input-number name="amount" min="0" label="{{ __('Invoice.amount') }}" :value="$payments->amount" />
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <x-dashboard.text-area-form name="description" label="{{ __('Fee.desc') }}" :value="$payments->description" />
    </div>
</div>
<!-- /.card-body -->
