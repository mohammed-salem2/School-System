...
-->
<html lang="{{ app()->getLocale() }}" dir="{{app()->getLocale() == 'ar'  ? 'rtl' : 'ltr' }}" direction="{{ app()->getLocale() == 'ar' ? 'rtl' : 'ltr' }}" style="direction: {{ app()->getLocale() == 'ar' ? 'rtl' : 'ltr' }};">
<!--begin::Head-->
...
<head>
    ...
    <link href="{{ asset('cms/assets/plugins/global/plugins.bundle.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('cms/assets/css/wizard.css') }}" rel="stylesheet" type="text/css" />
    ...
    @else
        <link href="{{ asset('cms/assets/css/style.bundle.rtl.css') }}" rel="stylesheet">
    @endif
